...
async def start(update: Update, context):
    ...
    # Send the welcome message and instructions every time /start is typed
    ...
    if user_id not in first_time_users:
        ...
        # If the user is not a first-time user, send the main menu
...
async def handle_start_button(update: Update, context):
    ...
    # Once the user clicks 'Start', display the welcome message and main menu
...
async def pay_now(update: Update, context: CallbackContext):
    ...
    print(f"🟢 Debug: User Orders -> {user_orders}")
